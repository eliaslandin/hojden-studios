...
export default function Page() {
  return (
    <PageContent>
      <Heading1 className="text-hojden-orange">höjden sessions</Heading1>
      <p>
      ...
      <p>
        ...
        <br/>
        The workshop is held by Ronald Salas, who has a degree in stage production and tech from Malmö University and a degree in lighting design from Stockholm University of the Arts. He  works mainly with lights for dance, opera and theatre but also installations.<br/>
        <br/>
      </p>
        <Heading3>Lisa Schåman: dance</Heading3>
      <p>
      ...
      <p>
        ...
        <br/>
        Bring clothes you are comfortable to both move and rest in!<br/>
        <br/>
      </p>
        <Heading3>Gergo D. Farkas: body scam mediation sessions</Heading3>
      <p>
      ...
      <HojdenImage alt="Dance class at höjden session." src="/hojden_session_dance_class.jpg" />
    </PageContent>
  );
}

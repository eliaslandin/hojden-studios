...
const content = {
  en: () => (
    <>
  <Heading1 className="pb-10">Welcome to höjden studios!</Heading1>
  <Post>
  ...
  <Post>
    ...
    <p>
      ...
      <ul className="list-disc pl-8">
        <li>
          <p>being a member of a community of all kinds of artists & culture workers.</p>
        </li>
        <li>
          <p>24/7 access to well equipped shared office area for the daily work as a freelancer.</p>
        </li>
        <li>
          <p>bookable private meeting room, 25kr/hour.</p>
        </li>
        <li>
          <p>kitchen and hang-out area, well supplied with coffee & tea.</p>
        </li>
        <li>
          <p>opportunity to book our 100m2 studio for the internal, and/or common are at-cost price of 100kr/hour weekdays, 50kr/hour weekends & evenings.</p>
        </li>
        <li>
          <p>Performance events, exhibition space, launch parties, annual festival & other events for all kinds of artists & culture workers.</p>
        </li>
        <li>
          <p>Discounted workshops such as: music production for stage, tech for stage, performance workshops. (see höjden sessions)</p>
        </li>
      </ul>
      <br/>
      <p>
  ...
  sv: () => (
    <>
  <Heading1 className="pb-10">Välkommen till höjden studios!</Heading1>
  <Post>
    <PostDate>24/03/22</PostDate>
    <Heading2>höjden sessions</Heading2>
    <HojdenImage
